...
type CarEdges struct {
	...
	// CarUtilities holds the value of the car_utilities edge.
	CarUtilities []*CarUtility `json:"car_utilities,omitempty"`
...
// CarUtilitiesOrErr returns the CarUtilities value or an error if the edge
// was not loaded in eager-loading.
func (e CarEdges) CarUtilitiesOrErr() ([]*CarUtility, error) {
	if e.loadedTypes[1] {
		return e.CarUtilities, nil
	}
	return nil, &NotLoadedError{edge: "car_utilities"}
}
...
// QueryCarUtilities queries the "car_utilities" edge of the Car entity.
func (c *Car) QueryCarUtilities() *CarUtilityQuery {
	return (&CarClient{config: c.config}).QueryCarUtilities(c)
}
